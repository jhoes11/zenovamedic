...
const Hero = () => {
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img src={heroImage} alt="Zenova Medic - Clínica médico estética de lujo" className="w-full h-full object-cover" />
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto fade-in-up flex flex-col items-center justify-center">
          <img src={logo} alt="Zenova Medic Logo" className="w-48 md:w-64 mx-auto mb-1.5" />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button size="lg" className="btn-premium text-lg px-8 py-4 hover:scale-105 transition-transform duration-300">
              <a href="https://zenovamedic.site.agendapro.com/pe" target="_blank" rel="noopener noreferrer">
                Agenda tu Cita
              </a>
            </Button>
            
            <Button variant="outline" size="lg" className="btn-outline-premium text-lg px-8 py-4 bg-white/10 backdrop-blur-sm border-white text-white hover:bg-white hover:text-primary">
